...
export function ContactSection() {
  ...
  const contactInfo = [
    {
      icon: Mail,
      label: "Email",
      value: "vittawat.soo@gmail.com",
      href: "mailto:vittawat.soo@gmail.com",
    ...
    },
    {
      ...
      href: "https://maps.google.com/?q=Nakhon+Pathom+Thailand",
  ...
  const socialLinks = [
    ...
    },
    {
      icon: Linkedin,
      label: "LinkedIn",
      href: "https://linkedin.com/in/vittawat-sootawee",
            ...
            <div className="text-center">
              <div className="mb-6">
                ...
                <h4 className="text-xl font-semibold text-gray-900 dark:text-white mb-2">
                  มีคำถามเกี่ยวกับผลงานของบูม?
                </h4>
                <p className="text-gray-600 dark:text-gray-300">
                  ลองคุยกับ AI ผู้ช่วยของบูมได้เลย! สามารถถามเกี่ยวกับประสบการณ์ ทักษะ โครงการ หรืออะไรก็ได้
                </p>
              </div>
              ...
              <div className="bg-blue-50 dark:bg-blue-900/20 rounded-lg p-6 mb-6">
                ...
                <div className="space-y-2 text-sm text-blue-700 dark:text-blue-300">
                  <p>• "บอกเกี่ยวกับประสบการณ์ทำงานของบูมหน่อย"</p>
                  <p>• "บูมมีทักษะด้าน AI อะไรบ้าง?"</p>
                  <p>• "มีอะไรน่าสนใจใน AI ไหม?"</p>
                  <p>• "ติดต่อบูมได้อย่างไร?"</p>
                </div>
              </div>
