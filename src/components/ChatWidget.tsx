...
export function ChatWidget() {
  ...
  const [messages, setMessages] = useState<Message[]>([
    {
      id: "1",
      content: "สวัสดีครับ! ผมเป็น AI ผู้ช่วยของบูม สามารถถามเกี่ยวกับประสบการณ์ ทักษะ หรือโครงการของเขาได้เลยครับ!",
      role: "assistant",
      timestamp: new Date(),
    },
  ]);
      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="fixed bottom-16 right-4 sm:bottom-24 sm:right-6 z-40 w-80 sm:w-96 h-80 sm:h-96 max-w-[calc(100vw-2rem)] bg-white dark:bg-gray-800 rounded-lg shadow-2xl border border-gray-200 dark:border-gray-700 flex flex-col"
          >
            {/* Header */}
            <div className="bg-blue-600 dark:bg-blue-500 text-white p-4 rounded-t-lg">
              <h3 className="font-semibold">คุยกับ AI ของบูม</h3>
              <p className="text-sm text-blue-100 dark:text-blue-200">ถามอะไรเกี่ยวกับบูมได้เลย!</p>
            </div>
